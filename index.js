...
// The nested function can't find the variable in it's own scope so it searches out side of it's scope.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(arr){
      const newArr = arr.filter(a => a.population < 5);
      return newArr;
  }
  ...
  */
  ...
  function USApop(arr){
    const anPop = arr.reduce((accumulator, a) => {
      return accumulator + a.population;
    }, 0)
    return anPop;
  }
...
// 🦄 💪 Stretch Task: Extend the base clas CuboidMaker with a sub class called CubeMaker.  Find out the formulas for volume and surface area for cubes and create those methods using the dimension properties from CuboidMaker.  Test your work by logging out your volume and surface area. 🦄 💪
